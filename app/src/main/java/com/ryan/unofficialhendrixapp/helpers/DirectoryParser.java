...
public class DirectoryParser {
    ...
    public ArrayList<Person> parse() {
        XmlPullParser parser = mContext.getResources().getXml(R.xml.staff);
        ...
        try {
            ...
            while (parser.next() != XmlPullParser.END_DOCUMENT) {
                ...
                if (name.equals( mContext.getResources().getStringArray(R.array.dir_keys)[0] )) {
                    personList.add(getEntry(parser));
                }
            }

            ( (Activity) mContext ).getPreferences(0)
                    .edit().putBoolean(mContext.getResources().getString(R.string.directory_filled_key), true)
                    .commit();
    ...
    private Person getEntry(XmlPullParser parser) throws XmlPullParserException, IOException {
        String item_key  = mContext.getResources().getStringArray(R.array.dir_keys)[0];
        String link_key  = mContext.getResources().getStringArray(R.array.dir_keys)[1];
        String name_key  = mContext.getResources().getStringArray(R.array.dir_keys)[2];
        String title_key = mContext.getResources().getStringArray(R.array.dir_keys)[3];
        String dept_key  = mContext.getResources().getStringArray(R.array.dir_keys)[4];
        String phone_key = mContext.getResources().getStringArray(R.array.dir_keys)[5];
        String email_key = mContext.getResources().getStringArray(R.array.dir_keys)[6];
        String line1_key = mContext.getResources().getStringArray(R.array.dir_keys)[7];
        String line2_key = mContext.getResources().getStringArray(R.array.dir_keys)[8];
        ...
        while (parser.next() != XmlPullParser.END_TAG) {
            ...
            else if (tag_name.equals(dept_key) ) dept = readCategory(parser, dept_key);
